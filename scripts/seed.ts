...
const SEED_USER_ID = "user_2jaaSpHHiR1xOaTf1itz0X2hN35"
...
const SEED_ACCOUNTS = [
  { id: "account_1", name: "Cheking", userId: SEED_USER_ID, plaidId: null },
  { id: "account_2", name: "Cheking", userId: SEED_USER_ID, plaidId: null },
]
...
const generateTransactionsForDay = (day: Date) => {
  ...
  for (let i = 0; i < numTransactions; i++) {
    ...
    SEED_TRANSACTIONS.push({
      ...
      date: day,
      amount: Math.round(formattedAmount),
      payee: "Merchant",
